/* empty css                           */
import { c as createComponent, r as renderTemplate, d as addAttribute, e as createAstro, m as maybeRenderHead, s as spreadAttributes, f as renderComponent, g as renderHead, h as renderSlot, A as AstroError, i as UnknownContentCollectionError, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, u as unescapeHTML } from '../astro_Bp5FequK.mjs';
import 'kleur/colors';
import pLimit from 'p-limit';
import { p as prependForwardSlash } from '../astro/assets-service_UQFKD4EZ.mjs';
import 'clsx';
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/Inicia una nueva aventura.md": () => import('../Inicia una nueva aventura_DourokLf.mjs'),"/src/content/posts/Instalacion JDK en Ubuntu.md": () => import('../Instalacion JDK en Ubuntu_LUUrE9zz.mjs')});
