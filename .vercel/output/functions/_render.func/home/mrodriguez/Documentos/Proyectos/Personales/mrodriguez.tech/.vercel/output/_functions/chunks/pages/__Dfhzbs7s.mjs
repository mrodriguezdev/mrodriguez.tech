...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="absolute bottom-2 left-0 right-0 text-center" data-astro-cid-sz7xmlte> <span class="text-sm text-zinc-800/90 dark:text-zinc-200/90" data-astro-cid-sz7xmlte>
&copy; ${creationYear} - ${currentYear} <a href="https://mrodriguezdev.me/" class="hover:underline" data-astro-cid-sz7xmlte>mrodriguezdev</a>
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "http://localhost:4321", "ASSETS_PREFIX": undefined}, { _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/Instalación JDK en Ubuntu.md": () => import('../Instalación JDK en Ubuntu_O9MvxQ70.mjs')});
...
let lookupMap = {};
lookupMap = {"posts":{"type":"content","entries":{"instalación-jdk-en-ubuntu":"/src/content/posts/Instalación JDK en Ubuntu.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/Instalación JDK en Ubuntu.md": () => import('../Instalación JDK en Ubuntu_Opq1ajYy.mjs')});
...
const $$PostLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1>${frontmatter.title}</h1> <p>${frontmatter.pubDate.toString().slice(0, 10)}</p> <p><em>${frontmatter.description}</em></p> <p>Written by: ${frontmatter.author}</p> <img${addAttribute(frontmatter.image.url, "src")} width="300"${addAttribute(frontmatter.image.alt, "alt")}> ${renderSlot($$result2, $$slots["default"])} ` })}`;
}, "/home/mrodriguez/Documentos/Proyectos/Personales/mrodriguez.tech/src/layouts/PostLayout.astro", void 0);
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PostLayout", $$PostLayout, { "frontmatter": entry.data }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
...
export { $$BaseLayout as $, ____slug_ as _, getCollection as g, siteConfig as s };
