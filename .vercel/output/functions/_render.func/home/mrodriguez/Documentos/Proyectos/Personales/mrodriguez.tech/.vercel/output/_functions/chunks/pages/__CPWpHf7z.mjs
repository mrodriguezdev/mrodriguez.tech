...
const $$Astro$6 = createAstro("https://mrodriguez.tech");
...
const $$Astro$5 = createAstro("https://mrodriguez.tech");
...
const $$Astro$4 = createAstro("https://mrodriguez.tech");
...
const $$Astro$3 = createAstro("https://mrodriguez.tech");
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://mrodriguez.tech", "ASSETS_PREFIX": undefined}, { _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
